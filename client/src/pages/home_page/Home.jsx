            ...
            <div className="home">
                <div className="home__navbar">
                    ...
                    <div className="home__navbar-sign">
                        <Link type="button" className={'homepage-button text-small'} to={'/signup/student'}>Sign up</Link>
                    </div>
                        ...
                        {toggleMenu && (
                            <div className="home__navbar-menu_container scale-up-center">
                                ...
                                <div className="home__navbar-menu_container-links-sign">
                                    <Link type="button" to={'/signin'}>Sign in</Link>
                                </div>
                            </div>
                        )}
                    </div>
                ...
                <div className="hero">
                    <div className="hero-content section__padding" id="home">
                        ...
                        <p>Get your English Proficiency, internship ,reference & all academic letters<br/>from the Kwame
                            Nkrumah University of Science and Technology</p>
